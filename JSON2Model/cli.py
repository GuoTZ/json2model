...
from renderer import TemplateRenderer,TemplateYYModelRenderer
...
class JSON2Mantle(object):
    ...
    def get_template_data(self):
        ...
        for model_name, properties in self.properties.items():
            ...
            joined_transformers = '\n'.join(
                filter(lambda x: x, map(objc_tpl.transformer_yytpl, properties)))
...
def main():
    ...
    template_renderer = TemplateYYModelRenderer(render_h, render_m, args.output_dir)
